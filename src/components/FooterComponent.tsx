...
const FooterComponent = () => {
    return (
        <div className="container mx-auto md:max-w-5xl px-12 font-Poppins mt-24 py-12 ">
            <div className="socialIcons flex items-center space-x-10 justify-center">
