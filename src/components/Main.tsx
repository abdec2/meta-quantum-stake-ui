            ...
            <div className="main flex items-center justify-between flex-wrap md:flex-nowrap">
                <div className="w-full md:w-1/2 md:pr-8 mb-8 z-20">
                    <div className="stakePanel bg-[color:var(--cards-bg)] p-6 w-full">
                        <h3 className="uppercase font-semibold text-md font-Poppins">Participate Meta-Quantum Stake</h3>
                        <h2 className="font-extrabold text-2xl ml-3">0000.00 QTH</h2>
                        <div className="font-Poppins mt-6 px-3 border-b-2 border-[color:var(--border-color)]">
                            <p className="font-normal">Total Stake</p>
                        </div>
                        <StakeDetails />
                        <StakeForm />
                    </div>
                ...
                <div className="stakeInfo md:pl-20 w-full md:w-1/2 mb-8 z-10">
                    <div className="flex flex-col space-y-11 items-center justify-center">
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-center justify-between">
                            <div>
                        ...
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-center justify-between">
                            <div>
                                <h2 className="font-extrabold text-2xl">2450</h2>
                        ...
                        <div className="flex min-h-[8rem] bg-[color:var(--cards-bg)] w-full p-8 items-center justify-between">
                            <div>
                                <h2 className="font-extrabold text-2xl">1,000,000.00</h2>
